...
/// Implements Contemporary Academic Minimalism design style with Focused Authority Palette
/// optimized for educational technology mobile applications.
class AppTheme {
  AppTheme._();

  // Focused Authority Palette - Color specifications
  static const Color primaryLight = Color(0xFF2563EB); // Deep professional blue
  static const Color primaryVariantLight =
      Color(0xFF1D4ED8); // Darker blue variant
  static const Color secondaryLight =
      Color(0xFF64748B); // Sophisticated slate gray
  static const Color secondaryVariantLight =
      Color(0xFF475569); // Darker slate variant
  static const Color accentLight = Color(0xFF059669); // Success green
  static const Color warningLight = Color(0xFFDC2626); // Alert red
  static const Color backgroundLight = Color(0xFFFAFAFA); // Warm off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFDC2626); // Alert red for errors
  ...
  static const Color onBackgroundLight = Color(0xFF1F2937); // Deep charcoal
  static const Color onSurfaceLight = Color(0xFF1F2937); // Deep charcoal
  static const Color onErrorLight = Color(0xFFFFFFFF); // White on error

  // Dark theme colors (maintaining same palette philosophy)
  static const Color primaryDark =
      Color(0xFF3B82F6); // Lighter blue for dark mode
  static const Color primaryVariantDark = Color(0xFF2563EB); // Original blue
  static const Color secondaryDark = Color(0xFF94A3B8); // Lighter slate gray
  static const Color secondaryVariantDark = Color(0xFF64748B); // Original slate
  static const Color accentDark = Color(0xFF10B981); // Lighter success green
  static const Color warningDark = Color(0xFFEF4444); // Lighter alert red
  ...
  static const Color onPrimaryDark = Color(0xFFFFFFFF); // White on primary
  static const Color onSecondaryDark = Color(0xFF000000); // Black on secondary
  static const Color onBackgroundDark = Color(0xFFF8FAFC); // Light text on dark
  static const Color onSurfaceDark = Color(0xFFF8FAFC); // Light text on surface
  static const Color onErrorDark = Color(0xFFFFFFFF); // White on error

  // Additional semantic colors
  static const Color borderLight = Color(0xFFE5E7EB); // Subtle light gray
  ...
  static const Color textPrimaryLight = Color(0xFF1F2937); // Deep charcoal
  static const Color textSecondaryLight = Color(0xFF6B7280); // Muted gray
  static const Color textDisabledLight = Color(0xFF9CA3AF); // Lighter gray

  static const Color textPrimaryDark = Color(0xFFF8FAFC); // Light text
  static const Color textSecondaryDark = Color(0xFFCBD5E1); // Muted light
  static const Color textDisabledDark = Color(0xFF64748B); // Darker muted
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Card theme with progressive disclosure design
    cardTheme: CardTheme(
      color: surfaceLight,
      elevation: 2.0, // Gentle depth without heavy visual weight
      shadowColor: overlayLight,
    ...
    // Button themes with solid colors for maximum clarity
    ...
    // Typography with Inter font family for consistency
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration optimized for mobile readability
    ...
    // Interactive elements with status-aware feedback
    ...
    // Tab bar theme for clean navigation
    ...
    // Dialog theme for modal presentations
